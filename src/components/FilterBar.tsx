import { Filter, X, FileText, Image, Video, Hash, Layers, Heart, ArrowUpDown } from 'lucide-react';
import type { SortOrder } from '../hooks/usePrompts';
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <div className="relative inline-block text-left">
                <select
                  ...
                  className="appearance-none vp-filter-selected px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 flex items-center space-x-2 whitespace-nowrap"
                >
